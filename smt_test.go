...
func TestSparseMerkleTreeUpdateBasic(t *testing.T) {
	...
	value, err = smt.GetDescend([]byte("testKey"))
	if err != nil {
	...
	value, err = smt.GetDescend([]byte("foo"))
	if err != nil {
	...
	value, err = smt.GetDescend([]byte("testKey2"))
	if err != nil {
	...
	value, err = smt2.GetDescend([]byte("testKey"))
	if err != nil {
